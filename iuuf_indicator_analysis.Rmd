...
```{r}
skylight_analysis_2 <- glm(skylight_treatment ~ aquaculture_production_metric_tons + capture_fisheries_production_metric_tons, data = fishing_skylight_df, family = binomial)
