...
>>>>>>> 395bdb7f9449e89b25cd98d47d946bd6f8e312e6
...
scaled_sub_df <- scaled_sub_df[, c(1, 3, 2, 4:13)] # reorganizing so country and skylight adoption are first 
```
...
##### Model 1 
```{r}
glm_2.1 <- glm(skylight_treatment ~ vessels_on_iuu_lists+
                 registered_vessels_with_foreign_or_unknown_ownership+
                 mandatory_vessel_tracking_for_commercial_seagoing_fleet+
                 size_of_eez+
                 dependency_on_fish_for_protein+
                 ...
                 ratio_capture+
                 gdp_per_capita, 
               data = scaled_sub_df_2, family = binomial)
